...
class Hxd extends Stream.Transform {
  ...
  _output( line ) {
    this.lineBuffer.push( Hxd.defineUndefined( line ) + '\n')
  ...
  _process( chunk ) {
    ...
    while( offset < this.buffer.length ) {
      ...
      this.hex = hex
      line = this.lineNumbers ? Hxd.lineno( this.lineno, this.color ) + '  ' : ''
      line += this.color ? Hxd.colorHexCols( Hxd.hexCols( hex ) ) : Hxd.hexCols( hex )
